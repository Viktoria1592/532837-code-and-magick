...
function renderStatistics(ctx, names, times) {
  ...
  for (var i = 0; i < names.length; i++) {
    ...
    ctx.fillRect(CLOUD_X + GAP_FROM_LEFT_SIDE_OF_CLOUD + (BAR_WIDTH + GAP_BETWEEN_BARS) * i, CLOUD_Y + CLOUD_HEIGHT - GAP - TEXT_HEIGHT - GAP, BAR_WIDTH, -((BAR_MAX_HEIGHT * times[i])) / getMaxElement(times));
    ctx.fillStyle = 'black';
